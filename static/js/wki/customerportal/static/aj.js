...
// 	    if (!xEnabled) {
// 	    	swal('Please check the box to proceed');
// 	    	// $("#btncheck").show();
// 	   		// $("#low").hide();
// 	    	return false
...
$(document).ready(function(){
	$('#btncheck').click(function () {
	    ...
	    if (click==false) {
	    	swal('Please read and accept the Terms and condition to continue');
	    	// $("#btncheck").show();
	   		// $("#low").hide();
	    	return false
	...
	// 	var click = document.getElementById('click').checked;
	//     if (click==false) {
	//     	alert('Please read the teams and condition then accept to proceed');
	//     	// $("#btncheck").show();
	//    		// $("#low").hide();
	//     	return false
...
$(document).ready(function(){
	$("#checkhid").click(function(){
		alert('Please read the terms and condition then accept to proceed');
		    	// $("#btncheck").show();
		   		// $("#low").hide();
...
//             var id = $(this).attr('id');
//             if ($('#' + id).prop('checked')) {
//             	$('input[id="btncheck"]').css('display', 'none');
...
// });
// $(document).ready(function() {
// 	$('input[id="btncheck"]').attr('disabled', true);
// 	$('#click').click(function () {
// 		if($('input[id="#click"]').is(':checked');){
// 			$('input[id="btncheck"]').attr('disabled', false);
// 		}else{
// 			$('input[id="btncheck"]').attr('disabled', true);
// 		}
...
$(this).append("<i class=\"fa fa-spinner fa-spin loader\" style=\"font-size:24px\"></i>");
	...
	//	//hr.responseText);
		...
		else
		{
			$(".loader").remove();
			document.getElementById("click").click();		
			$("body").append("<div class=\" fade in\"></div>");
			$("#myModal").addClass("in");
			$(".modal-body").html(xhr.responseText);
...
$(".login").on("click",function(e)
{
	...
	xhr.addEventListener("load",function(e)
	{
		...
		hrm_alert("LOGIN WAS SUCCESSFUL");
		// ...<br/> <a href=\"/account/\">click here</a> if page doesn't redirects
		console.log(xhr.responseText);
...
$(".admin_login").on("click",function(e)
{
	...
	xhr.addEventListener("load",function(e)
	{
		...
		if(xhr.responseText == parseInt(1))
		{
			...
			xhr.responseText
		$(".modal-body").html("LOGIN WAS SUCCESSFUL");
		// ...<br/> <a href=\"../dpadmin/\">click here</a> if page doesn't redirects
		console.log(xhr.responseText);
